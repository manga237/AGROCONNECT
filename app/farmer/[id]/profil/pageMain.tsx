...
import { ArrowBigLeftIcon, ArrowBigRightIcon, Search,UserCircle2 } from "lucide-react";
      ...
      <main className="m-2 w-full">
        ...
        <UserCircle2 className="w-full my-5 h-70 bg-blue-300" size={50} />
          <div className="flex flex-col gap-4 text-3xl font-bold">
            <p>Nom: <span className="text-blue-500">{user.nom}</span></p>
            <p>Prenom: <span>{user.prenom}</span> </p>
            <p>Numero: <span>{user.numero}</span> </p>
          </div>
      </main>
    </div>
  );
